                                ...
                                <tr>
                                    ...
                                    <td class="text-start" colspan="3">
										<div class="d-flex align-items-center justify-content-start"> 
												<input type="text" id="content" name="content" value="<?=$content?>" class="form-control fs-6"  autocomplete="off"  style="width:70%;"  onkeydown="if(event.keyCode == 13) { phonebookBtn('content'); }"  placeholder="코드연동을 위해 검색해서 입력해주세요" > &nbsp;
