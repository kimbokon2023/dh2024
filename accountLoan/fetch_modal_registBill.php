...
if ($mode === 'update' && $num) {
	...
	include  $_SERVER['DOCUMENT_ROOT'] . "/account/_request.php";
    $mode = 'insert';
    $registDate = date('Y-m-d');
    $inoutsep = '지출';
    $amount = 0;
    $content = '차입금상환';  // 기본값 설정 
    $content_detail = '차입금에 대한 원금상환';  // 기본값 설정 
}

$title_message = ($mode === 'update') ? '세금계산서 수정' : '세금계산서 신규 등록';
...
// '경동기업'과 '주일기업'만 필터링
$Suboptions = array_filter($Suboptions, function($key) {
    return in_array($key, ['경동기업', '주일기업']);
});
        ...
        <div class="card justify-content-center">
            ...
            <div class="card-body">
                <div class="row justify-content-center text-center">
                    <div class="d-flex align-items-center justify-content-center m-2">
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td class="text-center fs-6 fw-bold" style="width:150px;">계산서발행일</td>
                                    ...
                                    <td class="text-center" style="width:200px;">
                                        <div>                                            
                                            <input type="radio" class="form-check-input" id="expense" name="inoutsep" value="지출" checked >
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" colspan="3">
                                        <select id="bankbook" name="bankbook" class="form-select form-select-sm mx-1 d-block w-auto mx-1" >
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <select id="content" name="content" class="form-select form-select-sm mx-1 d-block w-auto mx-1" >
								...
								<td class="text-center">
									<select id="contentSub" name="contentSub" class="form-select form-select-sm mx-1 d-block w-auto mx-1" >
                                ...
                                <tr>
                                    ...
                                    <td class="text-center fs-6 fw-bold" colspan="2">
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="d-flex justify-content-center">
                    <button type="button" id="BillsaveBtn" class="btn btn-dark btn-sm me-3">
                        <i class="bi bi-floppy-fill"></i> 저장
                    </button>
                    <?php if($mode != 'insert') { ?>
                    <button type="button" id="BilldeleteBtn" class="btn btn-danger btn-sm me-3">
