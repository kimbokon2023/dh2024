...
<div class="container" >  
 ...
 <!-- 1개의 영상마다 구분됨 -->
	  ...
	  <div class="d-flex p-2 mb-2 justify-content-center"> 
		    <h4 class="text-secondary text-center"> 
				<iframe width="560" height="315" src="https://youtube.com/embed/uryb3Bimf6g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		    </h4>	
	  </div>
 <!-- 1개의 영상마다 구분됨 -->
  	  <div class="d-flex p-2 mb-2 mt-3 justify-content-center"> 		 
