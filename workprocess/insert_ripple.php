...
try{
    ...
    $sql = "insert into " . $DB . ".workprocess_ripple(parent, id, name, nick, content, regist_day) ";
    $sql.= "values(?, ?, ?, ?, ?,now())"; 
    ...
    header("Location:https://dh2024.co.kr/workprocess/view.php?tablename=$tablename&num=$num");
