...
if ($mode == "modify") {
    ...
    try {
        ...
        $sql = "UPDATE m_order SET 
            ...
            inputSum1=?, inputSum2=?, inputSum3=?, inputSum4=?              
            WHERE num=? LIMIT 1";
...
if ($mode == "insert" || $mode == "copy") {
    ...
    try {
        ...
        $sql = "INSERT INTO m_order (
            orderDate, memo, orderlist, update_log, first_writer, totalsurang, totalamount, inputSum1, inputSum2, inputSum3, inputSum4
        ) VALUES (
            ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
        )";  // 11개 컬럼
