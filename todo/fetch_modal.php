...
if ($mode === 'update' && $num !=='undefined' ) {
    try {
        ...
        include $_SERVER['DOCUMENT_ROOT'] . '/todo/_row.php';
                    ...
                    <div class="d-flex align-items-center justify-content-center m-2">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" colspan="3">
                                        <ul id="approverList" class="list-group" style="width:80%;">
                                            ...
                                            $sql = "SELECT id, name, position FROM " . $DB . ".member WHERE company='대한' AND position !='대표이사' AND position !='전산실장' and  quitDate='0000-00-00' ORDER BY numorder ASC";
                                            $stmh = $pdo->prepare($sql);
                                            $stmh->execute();
                                ...
                                <tr>
                                    <td class="text-center fs-6 fw-bold" style="width:150px;">요청인 내용</td>
                                    <td class="text-center" colspan="3">
                                        <input type="text" class="form-control fs-6" id="title" name="title" value="<?= $title ?>" autocomplete="off">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fs-6 fw-bold" style="width:150px;">실행하실분 메모</td>
                                    <td class="text-center" colspan="3">
                                        <input type="text" class="form-control fs-6" id="reply" name="reply" value="<?= $reply ?>" autocomplete="off">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fs-6 fw-bold" style="width:150px;">진행상태</td>
                                    <td class="text-center">
                                        <input type="text" class="form-control fs-6" id="work_status" name="work_status" value="<?= $work_status ?>" autocomplete="off">
                                    </td>
                                    <td class="text-center fs-6 fw-bold" style="width:150px;">요청처리일</td>
                                    <td class="text-center">
                                        <input type="date" class="form-control fs-6" id="deadline" name="deadline" style="width:130px;" value="<?= $deadline ?>">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
