...
$find1="경동";
$find2="대신";
$con1 ="   where  (delivery like '%$find1%') and (outdate between date('$fromdate') and date('$Transtodate')) and (regist_state='2') order by outdate ";
$con2 ="   where  (delivery like '%$find2%') and (outdate between date('$fromdate') and date('$Transtodate')) and (regist_state='2') order by outdate ";
$a= $con1 . "desc ";  //경동화물/화물
$b= $con2 . "desc ";   //대신화물/화물
