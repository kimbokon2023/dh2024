...
<form id="board_form" method="post" enctype="multipart/form-data"  >		
	...
	<div class="container">	
		...
		<div class="card-header">	
			<h6 class="text-center my-0 me-md-auto"> <?=$title_message?>   </h6>
		</div>
		<div class="card-body">						 
			<div class="row mt-2 mb-2">
				<div class="col-sm-6">
						<button id="SavesettingsBtn" type="button" class="btn btn-dark btn-sm me-4">
				...
				<div class="card-body">							
						 <div class="d-flex justify-content-start align-items-center mt-1 mb-2" >														
							...
							<input  type="text" id="EGI" style="color:brown;text-align:right;" name="EGI" size="6" value="<?=$readIni['EGI']?>" onkeyup="inputNumberFormat(this)"> 								 
							 <span class="text-center" style="width:100px;"> 201 HL </span>						  					   
							...
							<span class="text-center" style="width:100px;"> 201 MR </span>						  					   
						 ...
						 <div class="d-flex justify-content-start align-items-center mt-1 mb-2" >																																		
							 <span class="text-center" style="width:100px;"> 304 HL </span>						  					   
							...
							<span class="text-center" style="width:100px;"> 304 MR </span>						  					   
							...
							<span class="text-center" style="width:100px;"> 특수소재평균 </span>						  					   
