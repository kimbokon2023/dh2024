...
<div id="fabriclotModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-lg" role="document" >
        <div class="modal-content ">
		  ...
		  <div class="modal-footer">		
             발주수량(참고) :  <input type="number" id="fabricrequest_qty" name="fabricrequest_qty" class="form-control text-center me-2" style="width:100px;" />   		  
			<button type="button" class="btn btn-dark btn-sm fabricadaptBtn me-2" > 발주적용</button>
