...
if(isset($_SESSION["DB"]))
 ...
 if(!isset($_SESSION["level"]) || $level>8) {
          /*   alert("관리자 승인이 필요합니다."); */
		 $_SESSION["url"]='http://8440.co.kr/work_voc/write_form.php' ; 		  		 
		 sleep(1);
...
if($_SESSION["userid"]==$item_id || $_SESSION["userid"]=="admin" || $_SESSION["name"]=="이미래" ||
	   $_SESSION["level"]==1 )
	{
?>		
		<button type="button"   class="btn btn-danger btn-sm me-1" onclick="javascript:del('delete.php?num=<?=$num?>&page=<?=$page?>')"> <ion-icon name="trash-outline"></ion-icon> 삭제 </button>	 &nbsp;
<?php  	}    ?>		
