...
$pdo = db_connect();
    ...
    $sql = "insert into " . $DB . ".suggestion_ripple(parent, id, name, nick, content, regist_day) ";
    $sql.= "values(?, ?, ?, ?, ?,now())"; 
    ...
    header("Location:https://dh2024.co.kr/suggestion/view.php?tablename=$tablename&num=$num");
