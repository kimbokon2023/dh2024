...
$common = " WHERE deadline between '$fromdate' and '$Transtodate' and deliverymethod='경동공장' AND is_deleted IS NULL  ORDER BY orderdate ASC ";
...
<form id="board_form" name="board_form" method="post" action="plan_making_kd.php">  
...
<div class="d-flex align-items-center justify-content-center mb-1 m-2">	
        ...
        <thead class="table-primary">
            <tr>
                <th class="text-center align-middle" style="width:100px;" >출고예정</th>                
                ...
                <th class="text-center align-middle"  style="width:150px;" >수령인 서명</th>
            </tr>
        </thead>
        <tbody>
...
<?php
 ...
 try{  
   ...
   while($row = $stmh->fetch(PDO::FETCH_ASSOC)) {	
		...
		print ' <td class="text-center align-middle"> </td>';
		print '</tr>';
