...
if ($fromdate === "" || $fromdate === null || $todate === "" || $todate === null) {
    $fromdate = date("Y-m-d", strtotime("-8 weeks", strtotime($currentDate))); // 2개월 이전 날짜
...
<div class="container-fluid">  
	...
	<div class="d-flex  p-1 m-1 mt-1 mb-1 justify-content-center align-items-center"> 	  
	   ...
	   <input type="date" id="todate" name="todate"  class="form-control me-1"   style="width:100px;" value="<?=$todate?>" >  &nbsp;     </span> 
		...
		<div class="inputWrap">
				<input type="text" id="search" name="search" value="<?=$search?>" onkeydown="JavaScript:SearchEnter();" autocomplete="off"  class="form-control text-start" style="width:150px;" > &nbsp;			
...
<table class="table table-hover" id="myTable">
  <thead class="table-primary">
    <tr>
      ...
      <th class="text-center " style="width:50px;">출고예정</th>
	  ...
	  <th class="text-center text-danger" style="width:70px;"> <i class="bi bi-image"></i>  출하</th>		  
