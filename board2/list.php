...
<div class="container justify-content-center ">  
 ...
 <div class="d-flex mt-3 mb-1 justify-content-center  align-items-center"> 
    ...
    <div class="input-group p-1 mb-1 justify-content-center">	
          <?php if($level == '1') { ?>	
			<button type="button" class="btn btn-dark  btn-sm me-2" id="writeBtn"> <i class="bi bi-pencil"></i>  신규신규  </button> 			   
		  <?php } ?>
		   <input type="text" name="search" id="search" value="<?=$search?>" size="30" onkeydown="JavaScript:SearchEnter();" placeholder="검색어"> 
			<button type="button" id="searchBtn" class="btn btn-dark me-2"  > <i class="bi bi-search"></i> 검색 </button>		
			<button id="closeBtn" type="button" class="btn btn-outline-dark btn-sm" onclick="self.close();" > <i class="bi bi-x-lg"></i> 닫기 </button>						
	</div>
</div>
