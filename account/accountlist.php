...
<div class="container mt-3">
  <div class="card">
    ...
    <small class="ms-5 text-muted"> 법인계좌를 등록/수정/삭제 합니다. </small>  
    </div>
    <div class="card-body">
      <form id="addCardForm" method="post" action="accountlist.php" class="row g-3 mb-3">
        ...
        <div class="d-flex justify-content-center align-items-center text-center">
          ...
          <input type="text" name="memo" id="memo" class="form-control mx-1" placeholder="비고" autocomplete="off" style="width:200px;">
