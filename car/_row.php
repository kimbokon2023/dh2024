...
$inspectionDate = isset($row['inspectionDate']) ? $row['inspectionDate'] : '';
$inspectionDateTo = isset($row['inspectionDateTo']) ? $row['inspectionDateTo'] : '';
$fromInsuDate = $row['fromInsuDate'] ?? '';
$toInsuDate = $row['toInsuDate'] ?? '';
?>
