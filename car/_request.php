...
$inspectionDate = isset($_REQUEST['inspectionDate']) && $_REQUEST['inspectionDate'] !== '' ? $_REQUEST['inspectionDate'] : NULL;
$inspectionDateTo = isset($_REQUEST['inspectionDateTo']) && $_REQUEST['inspectionDateTo'] !== '' ? $_REQUEST['inspectionDateTo'] : NULL;
$fromInsuDate = $_REQUEST['fromInsuDate'] ?? '';
$toInsuDate = $_REQUEST['toInsuDate'] ?? '';
?>
