...
<div class="card justify-content-center text-center mt-5">
	...
	<div class="card-body">								
		<div class="d-flex justify-content-center text-center align-items-center mb-2">										
			...
			<button class="btn btn-success btn-sm" type="button" id="excelBtn"> <i class="bi bi-file-earmark-excel"></i> 엑셀저장 </button> &nbsp;&nbsp;
			<button class="btn btn-info btn-sm" type="button" id="aiPromptBtn"> <i class="bi bi-clipboard"></i> AI prompt 복사 </button> &nbsp;&nbsp;
