...
<div class="container justify-content-center align-items-center " style="width:415px;">
		...
		<div class="card-body text-center">
			<div class="d-flex mt-3 mb-3 align-middle justify-content-center align-items-center ">                     
				...
				작업일 
				<input type="date"   id="askdatefrom"  name="askdatefrom"  required  autofocus  value="<?=$askdatefrom?>" >
				</span>			
				<span class="form-control mt-2 mb-2">
				시간선택		&nbsp;&nbsp;					
			   ...
			   for($i=0;$i<count($item_arr);$i++) {
				...
				<span class="form-control mt-2 mb-2">
					...
					<div class="d-flex mt-3 mb-3 align-middle justify-content-center align-items-center ">  
						...
						<button id="saveBtn" class="btn btn-dark btn-sm me-1" type="button">  <ion-icon name="save-outline"></ion-icon>  저장 </button>
						
						<? if((int)$num>0 && ($user_name==='김보곤') ) {  ?>				
